sap.ui.define([
	...
	return Controller.extend("gve.controller.ThingPage", {
		formatter: formatter,
		onInit: function () {
		...
		_readDetailsService: function (oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_iot_529406714d2841ad82361fa3bc692b1d_gve_geo__propsetData,DYN_ENT_iot_529406714d2841ad82361fa3bc692b1d_gve_geo__propsetMeasures,DYN_ENT_iot_529406714d2841ad82361fa3bc692b1d_gve_geo__DefaultImagePropertySet"
				},
